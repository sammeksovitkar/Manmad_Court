...
const PrintLayout = ({ data }) => {
  ...
  <div style={{ marginBottom: '10px', width: '100%', textAlign: 'right' }}>
      ...
      <div style={{ marginTop: '15px' }}>
        ...
        <p className="body-paragraph">
          म्हणुन तुम्हाला याव्दारे या न्यायालयापुढे येत्या दिनांक <span className="data-placeholder">{data.summonDate}</span> रोजी सकाळी ठिक ११:०० वाजता उक्त फिर्यादीसंबंधाने तुम्हाला जे माहित आहे त्या बद्दल साक्ष देण्यासाठी उपस्थित होण्याचे आणि न्यायालयाचे परवानगीवाचून तेथुन न जाण्याचे समन्स पाठवण्यात येत आहे.
        </p>
        <p className="body-paragraph">
          या कामी रास्त सबबी शिवाय हयगय केला तर, तुम्हाला हजर राहण्याची सक् वॉती करण्यासाठी वॉरंट काढले जाईल.
        </p>
      </div>
